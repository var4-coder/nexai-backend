...
export function createApp() {
  ...
  // Désactive ETag : sinon Express renvoie 304 (body vide) sur GET /users/me
  // et le frontend ne peut plus lire l'utilisateur connecté.
  app.set('etag', false);
  ...
  app.use(helmet());
  // Pas de cache navigateur sur les réponses API (évite 304 / données périmées).
