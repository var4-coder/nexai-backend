  ...
  try {
    ...
    const clientMsg =
      type === 'launch_site'
        ...
        : type === 'generation_site'
          ? // Suite cohérente de l'attente : le client a été prévenu d'un
            // ralentissement, on lui dit qu'il n'a pas pu être résolu. Aucune
            // cause technique n'est dévoilée, et la phrase sur les crédits
            // le rassure immédiatement — il ne perd rien.
            'Cette création n’a pas abouti. Vos crédits restent attachés à votre commande : relancez quand vous voulez, c’est gratuit.'
          : undefined;
