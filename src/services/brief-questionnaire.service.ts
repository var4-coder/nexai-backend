...
/*
 * Les questions d'avatar ne figurent PAS ici.
 *
 * Le choix du présentateur a son propre composant, qui le MÉMORISE sur le
 * compte : le même présentateur revient d'une vidéo à l'autre, ce qui
 * construit une identité de marque. Le reposer dans le questionnaire
 * l'afficherait deux fois et ferait perdre cette mémorisation.
 */
...
export function questionnairePourMode(
  ...
  if (composition === 'presentateur') return [...MINI_FILM.slice(0, 1), ...COMMUNES];
