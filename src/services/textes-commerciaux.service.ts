...
const TEXTES_INITIAUX: {
  ...
  },
  {
    ...
    contenu:
      "Créer un site coûte 12 crédits en qualité Normale (2 propositions au choix) ou 25 en Premium. La mise en ligne coûte 15 crédits. Modifier les textes vous-même est gratuit ; les faire retoucher par l'IA coûte 8 crédits.",
  },
  {
