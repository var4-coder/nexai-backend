...
import { callGrok, callClaude, callClaudeVisionBase64, type ClaudeModel, type GrokModel } from '@/services/ai-clients';
...
async function appelerCodeur(
  ...
  if (modele.startsWith('claude-')) {
    return callClaude(modele as ClaudeModel, systemPrompt, [{ role: 'user', content: instruction }], opts);
  }
  return callGrok(
    modele as GrokModel,
    [
