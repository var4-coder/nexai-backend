...
const PLANS = [
  {
    ...
    inclus: [
      ...
      'Vidéo IA (pub voix off + avatar)',
    ],
    nonInclus: ['Créer un site', 'Créer un logo', 'Espace Agence'],
  },
  {
    id: 'createur',
    nom: 'Créateur+',
    ...
    nonInclus: ['Espace Agence', 'Mini-film / série'],
  },
  {
    id: 'agence',
    nom: 'Agence',
    ...
    inclus: [
      'Tout Créateur+',
      'Espace Agence (gestion multi-clients)',
