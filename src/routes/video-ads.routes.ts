...
videoAdsRouter.get('/tarifs', (_req: Request, res: Response) => {
  ...
  res.json({
    ...
    note:
      "Outils visibles pour tous les comptes, y compris essai gratuit et Starter. Génération réservée aux abonnements Créateur+, Agence et Pro Max ; Mini-film/série réservé à Pro Max. L'essai gratuit dispose du test vidéo 8s.",
  });
});
