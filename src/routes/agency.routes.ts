...
agencyRouter.patch(
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      // Archive l'état avant l'édition manuelle (Architecture v6, section 10)
      await enregistrerVersion(req.params.siteId, 'edition_manuelle', 'Édition rapide Espace Agence');
